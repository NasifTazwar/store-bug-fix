...
const showProducts = (products) => {
  ...
  for (const product of allProducts) {
    ...
    const starPercentage = (product.rating.rate/ 5) * 100;
    ...
    div.innerHTML = `<div class="single-product">
      ...
      <p><small>Reviews : (${product.rating.count})</small></p>
      <h2 class="product-title">Price: $ ${product.price}</h2>
...
const updateTaxAndCharge = () => {
  ...
  if (priceConverted > 200) {
    setInnerTextOfDeliveryCharge("delivery-charge", 30);
    setInnerText("total-tax", priceConverted * 0.2);
  }
  if (priceConverted > 400) {
    setInnerTextOfDeliveryCharge("delivery-charge", 50);
    setInnerText("total-tax", priceConverted * 0.3);
  }
  if (priceConverted > 500) {
    setInnerTextOfDeliveryCharge("delivery-charge", 60);
